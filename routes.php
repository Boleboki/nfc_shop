...
// // Products
// Router::get('/admin/products', 'AdminProductController@index')->only(AdminAuthMiddleware::class);
// Router::get('/admin/products/create', 'AdminProductController@create')->only(AdminAuthMiddleware::class);
// Router::post('/admin/products', 'AdminProductController@store')->only(AdminAuthMiddleware::class);
// Router::get('/admin/products/{id}/edit', 'AdminProductController@edit')->only(AdminAuthMiddleware::class);
// Router::put('/admin/products/{id}', 'AdminProductController@update')->only(AdminAuthMiddleware::class);
// Router::delete('/admin/products/{id}', 'AdminProductController@destroy')->only(AdminAuthMiddleware::class);

// // Admin users
// Router::get('/admin/users', 'AdminUserController@index')->only(AdminAuthMiddleware::class);
